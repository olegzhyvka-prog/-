...
**Не плутати з `task-brief.md`.** Той — для наших 21 працівника. Цей — для **живого
розробника** у команді засновника (станом на 2026-08-02 — одна людина, фронтенд).
